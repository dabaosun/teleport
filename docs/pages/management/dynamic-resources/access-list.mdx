...
spec:
  ...
  audit:
    recurrence:
      frequency: 6months[user-and-role.mdx](user-and-role.mdx)
  ...
  grants:
    roles:
      - support-engineer[user-and-role.mdx](user-and-role.mdx)
  membership_requires:
    roles:
      - engineer
```
...
"AccessLists" tab. Your AccessList should be displayed, open it, choose "Enroll
members" and add `bob`.
